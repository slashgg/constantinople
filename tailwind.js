...
let colors = {
  ...
  'alternative-black': 'var(--alternative-black)',
  'accent-black': 'var(--accent-black)',
  'primary-white': 'var(--primary-white)',
  'secondary-white': 'var(--scondary-white)',
  'alternative-white': 'var(--alternative-white)',
  ...
  'alternative-darker': 'var(--alternative-darker)',
  'alternative-dark': 'var(--alternative-dark)',
  alternative: 'var(--alternative)',
  'alternative-light': 'var(--alternative-light)',
  'alternative-lighter': 'var(--alternative-lighter)',

  'danger-disabled': '#b91d0c',
  'danger-active': '#d52815',
  danger: '#b91d0c',
  'danger-light': '#d52815',
  'danger-lighter': '#ec9b92',
  ...
  'grey-light': '#b8b5c0',
  'grey-lighter': '#dad8de',
  'grey-lightest': '#f8f7f9',
  'grey-bleach': 'var(--grey-bleach)',
};
...
module.exports = {
  ...
  */
  ...
  | values that are useful in most projects, but feel free to add other
  sizes | that are specific to your project here as well.
  |
  | Class name: .bg-{size}
  |
  */
  ...
  */
  ...
  |-----------------------------------------------------------------------------
  |
  | Here is where you define your border radius values. If a `default`
  radius | is provided, it will be made available as the non-suffixed
  `.rounded` | utility.
  |
  | If your scale includes a `0` value to reset already rounded corners,
  it's | a good idea to put it first so other values are able to override
  it.
  |
  ...
  */
  ...
  | give you a Bootstrap-style responsive container component out of the
  box.
  |
  | Be sure to view the complete plugin documentation to learn more about
  ...
  plugins: [
    ...
    function({ addUtilities }) {
      const transformation = {
        '.transition': { transition: 'all ease-in-out .12s' },
      };

      addUtilities(transformation);
    },
  ],
